...
const post_request = async ({ target, body }) => {
    try {
        ...
        let token=ACCOUNT_DATA!==null?{'Authorization':'Bearer '+ACCOUNT_DATA}:null
        const instance = axios.create({baseURL: "https://staging.vrda1.net", timeout: 1000, headers: token});
