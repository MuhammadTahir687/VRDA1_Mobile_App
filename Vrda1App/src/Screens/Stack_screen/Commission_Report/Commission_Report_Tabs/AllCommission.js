    ...
    return (
        <SafeAreaView style={{flex:1}}>
            ...
            <Dialogs visible={visible} onPress={()=>{setVisible(false)}} title={"Description"}>
                ...
                <Text style={{fontSize:13,paddingHorizontal:10 }}>Pin Package = {res.package_name}</Text>
                <Text style={{fontSize:13,paddingHorizontal:10 }}>Pin Package Price = {res.package_price}</Text>
                <Text style={{fontSize:13,paddingHorizontal:10 }}>Pin Package BV = {res.package_business_volume}</Text>
                <Text style={{fontSize:13,paddingHorizontal:10 }}>Generated By = {res.generated_by}</Text>
                ...
                <DoubleText text1={"Receiver"} text2={res.user}/>
                <DoubleText text1={"Generator"} text2={res.fromUser}/>
