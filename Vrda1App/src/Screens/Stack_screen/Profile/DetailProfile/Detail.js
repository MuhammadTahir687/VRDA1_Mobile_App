    ...
    return (
        <SafeAreaView style={{flex:1}}>
            <ImageBackground source={require("../../../../Assets/splash.png")} style={{flex:1}}>
                <ProfileView source={{uri: data.picture}} screen_title={name} username={data.title+". "} firstname={data.first_name+" "} lastname={data.last_name} update={"Profile Detail"} onPress={()=>navigation.goBack()} onPressForUpdate={()=>{navigation.navigate("UpdateProfile",{data:data,user:user})}}>
                    {name=="Personal Detail"?
                        <View style={{marginBottom:15}}>
                            <Text style={{fontSize:16,fontWeight:"bold", color:Colors.primary,paddingHorizontal:10,bottom:10}}>{name}:</Text>
                            <DoubleText text1={"Username"} text2={user.name?user.name:"Not Available"}/>
                            <DoubleText text1={"Joined"} text2={user.email_verified_at?user.email_verified_at:"Not Available"}/>
                            <DoubleText text1={"Primary Email"} text2={user.email?user.email:"Not Available"}/>
                        ...
                        <View style={{height:320}}>
                            ...
                            <ScrollView>
                                ...
                                <DoubleText text1={"Kin Name"} text2={data.kin_name?data.kin_name:"Not Available"}/>
                                <DoubleText text1={"Kin Relation"} text2={data.kin_relation?data.kin_relation:"Not Available"}/>
