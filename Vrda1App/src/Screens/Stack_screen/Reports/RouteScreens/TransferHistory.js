...
import {getTransferHistory} from "../../../../utilis/Api/Api_controller";
...
const TransferHistory = () => {
    ...
    return(
        <SafeAreaView style={{flex:1}}>
            ...
            <Text style={{textAlign:"center",fontWeight:"bold"}}>Transfer History</Text>
            <FlatList
                data={data}
            ...
            <Dialogs visible={visible} onPress={()=>{setVisible(false)}} title={"Description"} description={ids.admin_feedback?ids.admin_feedback:"Not Available"}>
                ...
                <DoubleText text1={"To"} text2={ids.createdFor?ids.createdFor:"Not Available"}/>
